 ...
 {  
      ...
      {  
           ...
           {  
                ...
                echo '<script>window.location="naewCart (1).php"</script>'; 
  ...
  border: 1px solid gray;
    ...
    <div class="welcome-text">    
      ...
      <ul class="nav-area">
        ...
        <li><a href="naewCart (1).php.php">ORDER CHOCOJERR</a></li>
        ...
        if (isset($_SESSION['shopping_cart']))
        {
         ...
         ?>
        <li><a href="img/myCart.php"  class="fas fa-shopping-cart" >MY CART(<?php echo $count;?>)</a></li>
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-4">
                        ...
                        <form method="post" action="naewCart (1).php?Product_Id=<?=$row['Product_Id']?>">
