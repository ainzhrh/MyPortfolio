 ...
 <html>  
      <head>  
           <title>Menu - Asian Cuisine</title>  
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <?php 
         ...
         ?>
        <li class=""><a href="cart.php"><span class="glyphicon glyphicon-shopping-cart"></span> [25] Cart</a></li>
      </li>
      ...
      <body>  
           ...
           <div class="container" style="width:700px;">  
                <h3 align="center">Asian Cuisine</h3><br />  
